        ...
        <div class="row">
            ...
            if(isset($_POST['add_pic_sub']))
            {
                ...
                if(mysqli_query($conn,$add_pic))
                {
                  ...
                  {
                      $add_tags="INSERT INTO tags(tag,search_no) values('$tag_value',0)";
            ...
            ?>
                ...
                <!--Explore-->
                <div id="explore_div" style="display: block;">
                  <div style="margin-top: 10px; margin-bottom: 10px;"><form action="" method="POST">FILTER : <select name="filter">
                ...
                <?php
                $value_fit=$_POST["filter"];
                if($value_fit=="random"){
                  $explore_query="SELECT * FROM pictures ORDER BY rand()";
                }
                else if($value_fit=="date"){
                 $explore_query="SELECT * FROM pictures ORDER BY id DESC"; 
                }
                  ...
                  if(mysqli_query($conn,$update_query))
                    {
                        ...
                        {
                            $add_tagss="INSERT INTO tags(tag,search_no) values('$tag_values',0)";
